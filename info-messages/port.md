...
**On most Minecraft server hosts:** You can open an additional port somewhere in your hosts dashboard, or you need to ask the support of your host *if* and *how* you can open an additional port.
